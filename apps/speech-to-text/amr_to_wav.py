...
# update by ollyja
# convert to wav (input is amr file with SILK_V3 header. if it's aud file, please update the file accordingly
# python wechat_amr_wav.py --silk-decoder SILKCodec/SILK_SDK_SRC_ARM/decoder /tmp/weixin/
#
...
def convert_silk_file(input_dir, input_file_name, decoder_file_path, output_dir):
    ...
    intermediate_file_2_name = input_file_name.replace(".amr", ".pcm")
    ...
    # print "decoder cmd: %s %s %s" % (decoder_file_path, intermediate_file_1_path, intermediate_file_2_path)
    print(f"decoder cmd: {decoder_file_path} {intermediate_file_1_path} {intermediate_file_2_path}")
