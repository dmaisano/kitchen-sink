    ...
    <section className="bg-[#2d3748] xl:w-72">
      <div className="flex justify-between px-4 py-3 xl:hidden">
        <div className="relative max-w-xs w-full">
          ...
          <input
            className="block w-full bg-gray-900 focus:outline-none focus:bg-white text-gray-900 focus:placeholder:text-gray-900 placeholder:text-gray-300 font-medium rounded-lg pl-10 pr-4 py-2"
      ...
      <form
        className={`xl:h-full xl:flex xl:flex-col xl:justify-between ${
          ...
          <div className="px-4 py-4 border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
            <div className="flex flex-wrap -mx-2">
              <label className="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                ...
                <select className="mt-1 form-select block w-full text-white shadow bg-gray-600 rounded-lg focus:bg-gray-500">
                  <option>4</option>
                </select>
              </label>
              <label className="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
